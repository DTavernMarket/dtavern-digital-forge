...
@Component({
  ...
  template: `
    <section id="produtos" class="py-20 bg-gradient-to-b from-background to-muted/30">
      <div class="container mx-auto px-4">
        ...
        <div class="text-center mb-16 space-y-4">
          <div class="inline-flex items-center space-x-2 bg-card/80 backdrop-blur-sm border border-tavern-brass/30 rounded-full px-4 py-2 text-sm mb-4">
            ...
            <span class="text-foreground font-medium">Produtos em Destaque</span>
          </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          <div 
            *ngFor="let produto of produtosEmDestaque(); trackBy: rastrearProduto"
            class="group bg-card/80 backdrop-blur-sm border-tavern-brass/30 overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-2 rounded-lg"
          >
            <!-- Imagem do Produto -->
              ...
              <div class="flex items-center justify-between text-sm">
                <div class="flex items-center space-x-1">
                  <div class="flex items-center">
                    ...
                    <span class="ml-1 text-foreground/80">{{ produto.avaliacao }}</span>
        ...
        <div class="text-center">
          <button routerLink="/produtos" class="px-8 py-3 bg-gradient-to-r from-accent to-magical-glow text-tavern-wood rounded-lg font-medium hover:shadow-lg transition-all">
